<template>
  <f7-page :name="$route.route.name" :class="$route.route.name">
    ...
    <p class="inputArea">
      <f7-input  type="textarea" placeholder="请输入同意理由(非必填)" v-model="remarks"></f7-input>
    </p>
    <p class="inputBtn">
      <f7-button fill v-on:click="doAgree">同意</f7-button>
  ...
  export default {
    ...
    methods: {
      doAgree:function(){
        ...
        util.svcInvoke('service','oa/doAgree',param,function(result){
